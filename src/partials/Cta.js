          ...
          <div className="bg-blue-600 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl" data-aos="zoom-y-out">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
                <h3 className="h3 text-white mb-2">Ready to build with Tesseract?</h3>
                <p className="text-white text-lg opacity-75">Give your team the tools required for digital transformation</p>
              </div>
