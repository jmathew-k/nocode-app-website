      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2">The most innovative companies use Tesseract</h2>
          </div>
          ...
          <div className="mb-12 md:mb-16">
            <ul className="flex flex-wrap justify-center text-sm font-medium -m-2">
              <li className="m-2">
                <a className="inline-flex text-center text-gray-100 py-2 px-4 rounded-full bg-blue-600 hover:bg-blue-700 transition duration-150 ease-in-out" href="#0">Healthcare</a>
              </li>
              <li className="m-2">
                <a className="inline-flex text-center text-gray-800 py-2 px-4 rounded-full bg-white hover:bg-gray-100 shadow-sm transition duration-150 ease-in-out" href="#0">Insurance</a>
              </li>
              <li className="m-2">
                <a className="inline-flex text-center text-gray-800 py-2 px-4 rounded-full bg-white hover:bg-gray-100 shadow-sm transition duration-150 ease-in-out" href="#0">Finance</a>
              </li>
              <li className="m-2">
              ...
              <li className="m-2">
                <a className="inline-flex text-center text-gray-800 py-2 px-4 rounded-full bg-white hover:bg-gray-100 shadow-sm transition duration-150 ease-in-out" href="#0">Consumer</a>
              </li>
            </ul>
          </div>
            ...
            <div className="grid gap-12 md:grid-cols-3 md:col-gap-6 md:row-gap-8 items-start">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <Link to="/blog-post" className="hover:underline">“How HubSpot saved 25% on developing costs by switching to Tesseract”</Link>
                  </h3>
                </header>
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="150">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <Link to="/blog-post" className="hover:underline">“How Facebook brought 13% cost savings to their bottom line with Tesseract's products.”</Link>
                  </h3>
                </header>
                <footer className="text-sm flex items-center mt-4">
                  <div className="flex flex-shrink-0 mr-3">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight">
                    <Link to="/blog-post" className="hover:underline">“How Tinder grew 115% and saved 120 Hours each week by outsourcing to Tesseract”</Link>
                  </h3>
                </header>
                <footer className="text-sm flex items-center mt-4">
                  <div className="flex flex-shrink-0 mr-3">
