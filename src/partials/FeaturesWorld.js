      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Planet Scale</h1>
            <p className="text-xl text-gray-600">Deploy and share apps developed between teams, and discover ready-made apps to common problems.</p>
          </div>
