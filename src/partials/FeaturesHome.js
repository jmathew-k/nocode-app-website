      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600">The no-code automation platform. Easily build digital solutions to automate complex business processes, without coding.</p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                ...
                <p className="text-xl text-gray-600">The ultimate toolbox to create applications that solve the hardest problems without writing a line of code </p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1"> Powerful decision engine</div>
                    <div className="text-gray-600">Powerful business rule engine that can implement your domain specific expert knowledge</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">AI functional blocks</div>
                    <div className="text-gray-600">Natural language comprehension & computer vision modules to supercharge your automation workflows</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Drag & drop interface designer</div>
                    <div className="text-gray-600">Create customised user interfaces like dashboards, forms, chatbots etc. to interact with users</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
